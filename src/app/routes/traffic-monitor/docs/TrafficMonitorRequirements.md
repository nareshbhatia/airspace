...
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| **Step 1** Layout Shell                  | Two-panel layout: fixed sidebar (256px) and full-height map. Sidebar shows placeholder content. Map loads with dark-v11 style.                                                                         | Two-panel flex layout with MapProvider, sidebar structure.                                                      |
